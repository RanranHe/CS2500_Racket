...
(check-expect (run '(and fals fals)) false)
(check-expect (run '(and (= 9 4) (= 5 5) (= 8 11))) false)
(check-expect (run '(and ((fun () tru)) tru tru)) true)
(check-error (run '(and)) "incorrect")

(check-expect (run '(or fals fals)) false)
(check-expect (run '(or (= 9 4) (= 5 5) (= 8 11))) true)
(check-expect (run '(or ((fun () tru)) tru tru)) true)
(check-error (run '(or)) "incorrect")

(check-expect (run '(substring "abcde" 0 0)) "")
(check-expect (run '(substring "abcde" 0 2)) "ab")
(check-expect (run '(substring "abcde" 3 4)) "d")

(check-expect (run '(string-append "abcd" "123")) "abcd123")
(check-expect (run '(string-append "abcd" "123" "456" "789")) "abcd123456789")
(check-expect (run '(string-append "abcd" "123" "456" "789" "012")) "abcd123456789012")
